                            ...
                            <div className="space-y-0.5">
                                {(!searchQuery || filterMatches('General')) && (
                                    <NavItem
                                        icon={<LayoutGrid size={18} />}
                                        label="General"
                                        active={activeView === 'settings-general'}
                                        onClick={() => onSelectView('settings-general')}
                                    />
                                )}
                                ...
                                {(!searchQuery || filterMatches('AI Context Engine')) && (
                                    <NavItem
                                        ...
                                        active={activeView === 'settings-context'}
                                ...
                                {(!searchQuery || filterMatches('About')) && (
                                    <NavItem
                                        icon={<Star size={18} />}
                                        label="About"
