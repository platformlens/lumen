...
export const NamespaceSelector: React.FC<NamespaceSelectorProps> = ({ namespaces, selected, onChange }) => {
  ...
  return (
    <div className="relative w-72" ref={dropdownRef}>
      <div
        className="bg-white/5 border border-white/5 hover:border-white/20 rounded-lg px-3 py-1.5 cursor-pointer flex justify-between items-center transition-all focus-within:ring-1 focus-within:ring-blue-500/30 focus-within:border-blue-500/30"
      ...
      {isOpen && (
        <div className="absolute top-full left-0 w-full mt-1 bg-[#1e1e1e] border border-white/10 rounded-lg shadow-xl z-[100] max-h-96 flex flex-col">
          <div className="p-2 border-b border-white/10">
            <input
              type="text"
              placeholder="Filter namespaces..."
              className="w-full bg-white/5 border border-white/5 rounded-lg px-2 py-1 text-sm text-gray-200 outline-none focus:border-blue-500/30 focus:ring-1 focus:ring-blue-500/30"
              value={search}
          ...
          <div className="overflow-y-auto flex-1 p-1">
            <div
              className={clsx(
                ...
                isAllSelected ? "bg-blue-500/20 text-blue-400" : "text-gray-300 hover:bg-white/10"
              )}
            ...
            {filteredNamespaces.length > 0 && <div className="h-px bg-white/10 my-1 mx-2"></div>}
              ...
              return (
                <div
                  ...
                  className={clsx(
                    ...
                    isSelected ? "bg-white/10 text-blue-400" : "text-gray-300 hover:bg-white/10"
                  )}
