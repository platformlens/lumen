                    ...
                    {sortedEvents.length === 0 ? (
                        ...
                        <>
                            ...
                            <div className="flex-1 min-h-0">
                                <div ref={containerRef} className="relative flex-1 h-full w-full min-h-[400px] audit-logs-table-container rounded-t-xl" style={{ overflowClipMargin: 0, overflow: 'clip' }}>
